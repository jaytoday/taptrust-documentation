...
These other services rely on user data for training their models. Even when they allow for opt-out of training, they still use your chat data for targeted advertising and other data mining. 
...
You can login to TapTrust from any device with a web browser, using your choice of your email address, your Google account, or your phone number. 
